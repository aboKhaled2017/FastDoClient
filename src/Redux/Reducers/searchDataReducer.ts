import { LOADING_SEARCH_DATA, SET_SEARCH_TABLE_DATA, 
         Stop_LOADING_SEARCH_DATA, SET_DATE_FILTER, SET_ERRORS_ON_FETCH_SEARCH_DATA, 
         SET_SEARCH_Q, SET_SEARCH_CITYIDS, SET_SEARCH_AREAIDS, SET_SEARCH_VALIDBEFORE,
         SET_SEARCH_ORDERBY, SET_SEARCH_PAGESIZE, SET_SEARCH_PAGENUMBER,
         SET_SEARCH_PAGENUMBER_AND_PAGESIZE, UPDATE_DRGS_SEARCH_ROW_AFTER_REQUEST_ADDED, 
         RESET_DATA_AFTERLOGOUT } from "../types"
