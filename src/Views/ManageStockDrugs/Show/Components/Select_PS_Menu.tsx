...
import {Set_StockProds_PageSize} from '../../../../Redux/Actions/StockDataActions'
...
interface IProps{
  Set_StockProds_PageSize:(val:number)=>void 
    pagingData:I_StockProds_Pagination
}
const  SelectPageSize_Menu=(props:IProps)=> {
    const classes = useStyles();
    const {pagingData,Set_StockProds_PageSize}=props;
...
export default connect((state:{stockData:IStocksDataState})=>({
    ...
    }),{Set_StockProds_PageSize})(SelectPageSize_Menu) as any;