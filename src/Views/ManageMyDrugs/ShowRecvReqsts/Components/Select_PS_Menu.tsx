...
import {Set_DrugsMadeReq_PageSize} from '../../../../Redux/Actions/DataActions'
...
interface IProps{
  Set_DrugsMadeReq_PageSize:(val:number)=>void 
    pagingData:I_Drug_Pagination
}
const  SelectPageSize_Menu=(props:IProps)=> {
    const classes = useStyles();
    const {pagingData,Set_DrugsMadeReq_PageSize}=props;
...
export default connect((state:{data:IDataState})=>({
    ...
    }),{Set_DrugsMadeReq_PageSize})(SelectPageSize_Menu) as any;