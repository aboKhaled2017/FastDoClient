...
import {Set_Drugs_PageSize} from '../../../../Redux/Actions/DataActions'
...
const  SelectPageSize_Menu=(props:IProps)=> {
    ...
    const {pagingData,Set_Drugs_PageSize}=props;
...
export default connect((state:{data:IDataState})=>({
    ...
    }),{Set_Drugs_PageSize})(SelectPageSize_Menu) as any;