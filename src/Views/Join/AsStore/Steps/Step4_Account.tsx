...
class STK_Account_Step extends Component<IStep_Props>{
    handleChange=(e:React.ChangeEvent<HTMLInputElement>)=>{
        this.props.On_Stk_Signup_Input_change(e.target.name,e.target.value,3)
    }
    ...
    render(){
        ...
        const errors=this.props.errors.signUp_Errors?.Stk_SignUp_Errors?.Step4_Errors;
        const {email,password,confirmPassword}=this.props.stk_DataOfSteps.step4;
        const allErrors=this.props.errors.signUp_Errors.Stk_SignUp_Errors.All_Form_Errors;
        return (
            <>
            <Box>
                {allErrors.Name && 
...
export default STK_Account_Step;