...
import { Grid, Typography, TextField, Button, CircularProgress, Theme, withStyles, Stepper, Paper, Step, StepLabel, StepContent } from '@material-ui/core'
                        ...
                        <StepContent className={classes.stepContent}>
                             <Grid container className={classes.form}>
                                ...
                                <Grid item xs={9} sm={6} md>                               
                                    ...
                                    {index===0 && <ViewSteps.PHInfoStep/>}
                                    {index===1 && <ViewSteps.PHIdentityStep/>}
                                    {index===2 && <ViewSteps.PHContactStep/>}
                                    {index===3 && <ViewSteps.PHAccountStep/>}
